...
-->
	...
	<body>
		<center>
			...
			<hr>
			Generation dun tableau HTML :<br> 
			<?php
				$qrcode = new QRcode(utf8_encode($msg), $err);
				$qrcode->displayHTML();
			?>
			<br>
			Generation d'une image PNG : <br>
			<?php
			for($i=1;$i<=100;$i++){
				?>
				<img src="./image.php?msg=<?php echo urlencode($msg . $i); ?>&amp;err=<?php echo urlencode($err); ?>" alt="generation qr-code" style="border: solid 1px black;">
				<?php
			}
			?>
