  ...
  <div class="content-wrapper">
   ...
   <i class="fa fa-money"></i> รายรับ - รายจ่ายในวันที่ <?php echo Datethai($today) ?> <small></small>
     <?php if($_SESSION['type']=='manager'){ ?>
       ...
       <?php }else{ ?>
           <button type="button" class="btn btn-success btn-xs insert_account"   data-toggle="modal" data-target="#modal-insert-account" style="float: right;font-size: 20px;"><spen class="glyphicon glyphicon-plus"> </spen> บันทึกรายรับ - รายจ่าย </button>
       <?php } ?>
      </h1>
          ...
          <div class="box">
           ...
           <div class="table-responsive">
             ...
             <td style="text-align: center;">
                      ...
                      <a href="<?php echo base_url(); ?>Genpdf/Account_d" class="btn btn-success btn-xs" target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์  </a>
