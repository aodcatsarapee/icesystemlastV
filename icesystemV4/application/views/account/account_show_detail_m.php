          ...
          <div class="box">
           ...
           <div class="table-responsive">
             ...
             <td style="text-align: center;">
                     ...
                     <a href="<?php echo base_url(); ?>Genpdf/Account_m" class="btn btn-success btn-xs" target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์  </a>
