...
<div class="modal  fade" id="modal-select-date-order">
  <div class="modal-dialog " style="width: 500px;">
    <div class="modal-content ">
      ...
      <div class="modal-body" id="insert" style="font-size: 15px;">
          ...
          <form class="form-horizontal" method="POST" id="select-date_order" name="select-date_order" enctype="multipart/form-data" >
