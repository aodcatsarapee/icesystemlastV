            ...
            <div class="table-responsive">
                    <table id="datatable-orders" class="table table-striped ">
                     <thead >
                      ...
                      <a href="<?php echo base_url(); ?>Genpdf/show_order_d" class="btn btn-success btn-xs" target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์  </a>
