...
// js insert data---------------------------------------------------------------------------------------------
            ...
            submitHandler: function(form) {
               ...
               var formData = new FormData($('#date_detail')[0]);
  ...
  <form class="form-horizontal" method="POST" id="date_detail" name="date_detail" enctype="multipart/form-data" >
