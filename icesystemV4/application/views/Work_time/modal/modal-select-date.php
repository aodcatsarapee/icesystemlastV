  ...
  <div class="modal-dialog " style="width: 500px;">
    <div class="modal-content ">
      ...
      <div class="modal-body" id="insert" style="font-size: 15px;">
          ...
          <form class="form-horizontal" method="POST" id="select-date_work_time" name="select-date_work_time" enctype="multipart/form-data" >
          ...
          <input type='hidden'  name='worktime' id='worktime' class='form-control' value="<?php echo base_url('Genpdf/print_work_detail') ?>"> 
