  ...
  <footer class="main-footer">
    ...
    <strong>icesystem &copy; 2018 </strong> All rights
    reserved.
  </footer>
...
<!-- validation-->
<script  src="<?php echo base_url(); ?>theme/plugins/validation/jquery.validate.js"></script>
...
<!-- controll backend-->
<!-- <script src="<?php //echo base_url() ?>theme/dist/js/backend/shopping.js"></script>
<script src="<?php //echo base_url() ?>theme/dist/js/backend/product.js"></script>
<script src="<?php// echo base_url() ?>theme/dist/js/backend/produce.js"></script>
<script src="<?php //echo base_url() ?>theme/dist/js/backend/produce_product.js"></script>
<script src="<?php// echo base_url() ?>theme/dist/js/backend/employee.js"></script>
<script src="<?php //echo base_url() ?>theme/dist/js/backend/debtor.js"></script>
<script src="<?php //echo base_url() ?>theme/dist/js/backend/account.js"></script>
<script src="<?php// echo base_url() ?>theme/dist/js/backend/department.js"></script>
<script src="<?php // base_url() ?>theme/dist/js/backend/customers.js"></script> -->

      <?php require('theme/dist/js/backend/shopping.js');  ?>
      <?php require('theme/dist/js/backend/product.js');  ?>
      <?php require('theme/dist/js/backend/produce.js');  ?>
      <?php require('theme/dist/js/backend/produce_product.js');  ?>
      <?php require('theme/dist/js/backend/employee.js');  ?>
