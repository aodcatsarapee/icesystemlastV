...
// js insert data---------------------------------------------------------------------------------------------
  ...
  <form class="form-horizontal" method="POST" id="edit_form_customer" name="edit_form_customer" enctype="multipart/form-data" >
          ...
          <div class="form-group  ">
            ...
            <div class="col-sm-7">
              <input class="form-control" type="text" name="cus_name" id="cus_name"  placeholder="เช่น สุทร " value="<?php echo $rs['customer_fname'] ?>" >
            </div>
          </div>
             <div class="form-group  ">
            <label class="col-sm-3 control-label"  >นามสกุล :</label>
            <div class="col-sm-7">
              <input class="form-control" type="text" name="cus_lname" id="cus_lname"  placeholder="เช่น ชาติไทย " value="<?php echo $rs['customer_lname'] ?>" >
            </div>
          </div>
