...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-money"></i> </i> ลูกหนี้<small></small>
      ...
      <div class="row">
       ...
       <!-- ./row -->
           ...
           <div class="table-responsive">
            ...
            <thead >
              ...
              <th style="text-align: center;">รหัสลูกหนี้</th>
                <th style="text-align: center;">ชื่อลูกหนั้</th>
          ...
          <tbody>
              ...
              <a href="Genpdf/debtor" class="btn btn-success btn-xs" target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์ </a>
