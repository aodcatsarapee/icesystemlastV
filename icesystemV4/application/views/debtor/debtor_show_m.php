    ...
    <section class="content-header">
      ...
      <?php 	$this->load->helper('Datethai'); 
         ...
         $get_mount = explode(" ",$date);
				?> 
      <i class="fa fa-money"></i> ลูกหนี้ชำระเงินในเดือน <?php echo $get_mount[1] ?> <small></small>
      ...
      <div class="row">
       ...
       <!-- ./row -->
          ...
          <tbody>
              ...
              <a href="Genpdf/debtor_m" class="btn btn-success btn-xs" target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์ </a>
