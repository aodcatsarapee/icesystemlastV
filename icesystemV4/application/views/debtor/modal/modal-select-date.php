...
<div class="modal fade "  id="modal-select-date-debtor">
  <div class="modal-dialog " style="width: 500px;">
    <div class="modal-content ">
      ...
      <div class="modal-body" id="insert" style="font-size: 15px;">
          ...
          <form class="form-horizontal" method="POST" id="select-date_debtor" name="select-date_debtor" enctype="multipart/form-data" >
