...
<!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <?php 	$this->load->helper('Datethai'); 
         ...
         $get_year = explode(" ",$date);
				?> 
        <i class="fa fa-product-hunt fa-1x "> </i>การผลิตสินค้าปี<?php echo $get_year[2] ?><small></small>
  ...
  <div class="table-responsive">
          ...
          <tbody>
           ...
           <a href="<?php echo base_url(); ?>Genpdf/produce_y" class="btn btn-success btn-xs" target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์  </a>
