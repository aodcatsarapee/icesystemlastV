      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <tbody>
             ...
             <a href="<?php echo base_url(); ?>Genpdf/produce_m" class="btn btn-success btn-xs" target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์  </a>
                </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
