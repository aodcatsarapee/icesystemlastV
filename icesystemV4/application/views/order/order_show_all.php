...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <i class="fa fa-money"></i> </i> ยอดสั่งสินค้าของลูกค้าทั้งหมด<small></small>
      ...
      <div class="row">
       ...
       <!-- ./row -->
         ...
         <?php } ?>
               ...
               <a href="Genpdf/order_detail_d?id=<?php echo 'all' ?>" class="btn btn-success btn-xs" target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์ </a>
