...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <i class="fa fa-shopping-cart "></i> ยอดสั่งสินค้าของลูกค้าในวันที่ <?php echo Datethai($today) ?>   <small></small>
      ...
      <div class="row">
       ...
       <!-- ./row -->
         ...
         <?php } ?>
               ...
               <a href="Genpdf/order_detail_d?id=<?php echo 'd' ?>" class="btn btn-success btn-xs" target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์ </a>
