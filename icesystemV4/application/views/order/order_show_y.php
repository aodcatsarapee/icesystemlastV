    ...
    <section class="content-header">
      ...
      <?php 	$this->load->helper('Datethai'); 
         ...
         $get_year = explode(" ",$date);
				?> 
      <i class="fa fa-shopping-cart "></i> ยอดสั่งสินค้าของลูกค้าในปี<?php echo $get_year[2] ?><small></small>
      ...
      <div class="row">
       ...
       <!-- ./row -->
         ...
         <?php } ?>
               ...
               <a href="Genpdf/order_detail_d?id=<?php echo 'y' ?>" class="btn btn-success btn-xs"  target="_blank" style="float: right ;font-size:20px;" ><spen class='glyphicon glyphicon-print'></spen> พิมพ์ </a>
