...
//                 //รับออเดอร์ตั้งแต่ตีสี่ถึง 10.59 หลังจากนี้จะปิดการรับออเดอร์ช่วงเช้าและใช้เวลาผลิตคร่าวๆ3ชม
//    $set_time = 'รับสินค้าในวันที่ '.$pro_date[0].' '.($pro_date[1])." เวลา 14.00 นาฬิกาเป็นต้นไป";

// }else if($cal[0] >= 11 && $cal[0] < 16){

//  $set_time = 'รับสินค้าในวันที่ '.$pro_date[0].' '.($pro_date[1])." เวลา 18.00 นาฬิกาจนถึง 21.00 น.เป็นต้นไป หรือเวลา 4.00 นาฬิกา 'ในวันถัดไปเป็นต้นไป ";

// }else if($cal[0] >=16  && $cal[0] <= 23){

//   $set_time = 'รับสินค้าในวันที่ '.Datethai($next_day)."เวลา 4.00 นาฬิกาเป็นต้นไป";

// }else{
// //จะเหลือแค่เลข 1 
//  $set_time = 'รับสินค้าในวันที่ '.$pro_date[0]."เวลา 4.00 นาฬิกาเป็นต้นไป";
// }
			?>
